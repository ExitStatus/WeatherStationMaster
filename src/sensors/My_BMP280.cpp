 ...
 *         optional wire
 */
My_BMP280::My_BMP280(TwoWire *theWire)
    : _cs(-1), _mosi(-1), _miso(-1), _sck(-1) {
  _wire = theWire;
  temp_sensor = new My_BMP280_Temp(this);
  pressure_sensor = new My_BMP280_Pressure(this);
}

My_BMP280::~My_BMP280(void) {
  delete temp_sensor;
 ...
 *         optional SPI object
 */
My_BMP280::My_BMP280(int8_t cspin, SPIClass *theSPI)
 ...
 */
My_BMP280::My_BMP280(int8_t cspin, int8_t mosipin, int8_t misopin,
                                 int8_t sckpin)
 ...
 */
bool My_BMP280::begin(uint8_t addr, uint8_t chipid) {
  _i2caddr = addr;
 ...
 */
void My_BMP280::setSampling(sensor_mode mode,
...
uint8_t My_BMP280::spixfer(uint8_t x) {
  if (_sck == -1)
...
*/
/**************************************************************************/
void My_BMP280::write8(byte reg, byte value) {
  if (_cs == -1) {
 ...
 */
uint8_t My_BMP280::read8(byte reg) {
  uint8_t value;
 ...
 */
uint16_t My_BMP280::read16(byte reg) {
  uint16_t value;
...
uint16_t My_BMP280::read16_LE(byte reg) {
 ...
 */
int16_t My_BMP280::readS16(byte reg) { return (int16_t)read16(reg); }

int16_t My_BMP280::readS16_LE(byte reg) {
 ...
 */
uint32_t My_BMP280::read24(byte reg) {
  uint32_t value;
 ...
 */
void My_BMP280::readCoefficients() {
 ...
 */
float My_BMP280::readTemperature() {
  int32_t var1, var2;
 ...
 */
float My_BMP280::readAltitude(float seaLevelhPa) {
  float altitude;
 ...
 */
float My_BMP280::seaLevelForAltitude(float altitude, float atmospheric) {
 ...
 */
/*
void My_BMP280::takeForcedMeasurement()
{
 ...
 */
uint8_t My_BMP280::getStatus(void) {
 ...
 */
Adafruit_Sensor *My_BMP280::getTemperatureSensor(void) {
  return temp_sensor;
}
 ...
 */
Adafruit_Sensor *My_BMP280::getPressureSensor(void) {
...
*/
/**************************************************************************/
void My_BMP280_Temp::getSensor(sensor_t *sensor) {
...
*/
/**************************************************************************/
bool My_BMP280_Temp::getEvent(sensors_event_t *event) {
  /* Clear the event */
...
*/
/**************************************************************************/
void My_BMP280_Pressure::getSensor(sensor_t *sensor) {
  /* Clear the sensor_t object */
  memset(sensor, 0, sizeof(sensor_t));
...
*/
/**************************************************************************/
bool My_BMP280_Pressure::getEvent(sensors_event_t *event) {
  /* Clear the event */
  memset(event, 0, sizeof(sensors_event_t));
