 ...
 */
#ifndef __MY_BMP280_H__
#define __MY_BMP280_H__
...
class My_BMP280_Temp : public Adafruit_Sensor {
public:
  /** @brief Create an Adafruit_Sensor compatible object for the temp sensor
      @param parent A pointer to the BMP280 class */
  My_BMP280_Temp(My_BMP280 *parent) { _theBMP280 = parent; }
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);

private:
  int _sensorID = 280;
  My_BMP280 *_theBMP280 = NULL;
};

/** Adafruit Unified Sensor interface for pressure component of BMP280 */
class My_BMP280_Pressure : public Adafruit_Sensor {
public:
  /** @brief Create an Adafruit_Sensor compatible object for the pressure sensor
      @param parent A pointer to the BMP280 class */
  My_BMP280_Pressure(My_BMP280 *parent) { _theBMP280 = parent; }
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);
...
public:
  ...
  My_BMP280(TwoWire *theWire = &Wire);
  My_BMP280(int8_t cspin, SPIClass *theSPI = &SPI);
  My_BMP280(int8_t cspin, int8_t mosipin, int8_t misopin, int8_t sckpin);
  ~My_BMP280(void);
...
private:
  ...
  My_BMP280_Temp *temp_sensor = NULL;
  My_BMP280_Pressure *pressure_sensor = NULL;
