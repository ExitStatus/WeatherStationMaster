...
boolean MyAHT10::begin(unsigned char _AHT10_address)
{
 ...
 **********************************************************/
float MyAHT10::GetHumidity(void)
{
 ...
 **********************************************************/
float MyAHT10::GetTemperature(void)
{
 ...
 **********************************************************/
float MyAHT10::GetDewPoint(void)
{
...
unsigned long MyAHT10::readSensor(boolean GetDataCmd)
{
...
unsigned char MyAHT10::readStatus(void)
{
