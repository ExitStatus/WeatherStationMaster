#ifndef Tiny_SH1106_h
#define Tiny_SH1106_h
...
class Tiny_SH1106 : public Adafruit_GFX {
 public:
  Tiny_SH1106(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS);
  Tiny_SH1106(int8_t RST);
